...
Use dd (or similar) to write the latest [Arch ISO](https://www.archlinux.org/download/) to a USB stick. You will need a USB A hub with both the Arch USB stick as well as a generic USB ethernet adapter considering that you'll need internet to retrieve Hans De Goede's kernel in order for wireless to work.
    ...
    cd /tmp/linux; \
      curl -O https://raw.githubusercontent.com/joshskidmore/gpd-pocket-arch-guide/master/files/njkli-repo/linux-jwrdegoede-docs-4.14.0rc3-1-audio-x86_64.pkg.tar.xz; \
      sudo pacman -U linux-jwrdegoede-docs-4.14.0rc3-1-audio-x86_64.pkg.tar.xz

    cd /tmp/linux; \
      curl -O https://raw.githubusercontent.com/joshskidmore/gpd-pocket-arch-guide/master/files/njkli-repo/linux-jwrdegoede-headers-4.14.0rc3-1-audio-x86_64.pkg.tar.xz; \
      sudo pacman -U linux-jwrdegoede-headers-4.14.0rc3-1-audio-x86_64.pkg.tar.xz

    cd /tmp/linux; \
      curl -O https://raw.githubusercontent.com/joshskidmore/gpd-pocket-arch-guide/master/files/njkli-repo/linux-jwrdegoede-4.14.0rc3-1-audio-x86_64.pkg.tar.xz; \
      sudo pacman -U linux-jwrdegoede-4.14.0rc3-1-audio-x86_64.pkg.tar.xz
